...
<!-- ================= PROFILE ================= -->
<div x-show="!editProfile" x-transition class="bg-white rounded-2xl shadow border border-gray-200 p-8">
    
    <!-- Judul Utama -->
    <div class="border-b border-gray-100 pb-5 mb-8">
        <h2 class="text-xl font-bold text-[#0B2F64] tracking-tight flex items-center gap-2">
    ...
    <!-- Layout Dua Kolom Berjejer Kiri-Kanan -->
    <div class="flex flex-row gap-14 items-start">

        <!-- FOTO PROFIL (SISI KIRI) -->
        <div class="w-44 shrink-0 flex flex-col items-center text-center">
            ...
            <h3 class="mt-4 text-xl font-bold text-gray-800 tracking-tight">
                {{ Auth::user()->name }}
            </h3>
        ...
        <!-- Menggunakan items-start pada flex dan mematikan pt-2 pada elemen pertama agar lurus sejajar atas foto -->
        <div class="flex-1 divide-y divide-gray-100 pr-4">

            <!-- Box Email -->
            <div class="py-4 first:pt-0 flex items-start gap-4">
                <!-- Warna ikon diubah ke text-gray-700 -->
                ...
                <div>
                    ...
                    <p class="text-base font-semibold text-gray-800 mt-0.5">{{ Auth::user()->email }}</p>
                </div>
            </div>
            ...
            <div class="py-4 flex items-start gap-4">
               ...
               <div class="w-6 h-6 text-gray-700 flex items-center justify-center shrink-0 mt-0.5">
                ...
                <div>
                    ...
                    <p class="text-base font-semibold text-gray-800 mt-0.5">{{ Auth::user()->divisi ?? '-' }}</p>
                </div>
            </div>
            ...
            <div class="py-4 last:pb-2 flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-base font-semibold text-gray-800 mt-0.5">{{ Auth::user()->jabatan ?? '-' }}</p>
                </div>
            </div>
    ...
    <div class="flex justify-end mt-6 border-t border-gray-100 pt-6">
       <button @click="editProfile = true"
        class="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 active:scale-95 text-white font-medium text-sm rounded-xl shadow-md transition-all duration-200 flex items-center gap-2 whitespace-nowrap">
    ...
    Edit Profil
                ...
                <div x-show="editProfile" x-transition class="bg-white rounded-2xl shadow border border-gray-200 p-8">
                    <div class="flex justify-between items-center border-b border-gray-100 pb-4 mb-6">
                        <h3 class="text-xl font-bold text-[#0B2F64]">Perbarui Informasi Profil</h3>
               ...
               <!-- ================= PASSWORD ================= -->
<!-- Ringkasan Password -->
<div x-show="!editPassword" x-transition class="bg-white rounded-2xl shadow border border-gray-200 p-8">
...
<!-- TOMBOL UBAH PASSWORD -->
    <div class="flex justify-start border-t border-gray-100 pt-6">
        <button @click="editPassword = true"
                class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-md shadow transition-all duration-150 shrink-0 whitespace-nowrap">
            Ubah Password
        </button>
    </div>
</div>
                ...
                <div x-show="editPassword" x-transition class="bg-white rounded-2xl shadow border border-gray-200 p-8">
                    <div class="flex justify-between items-center border-b border-gray-100 pb-4 mb-6">
                        <h3 class="text-xl font-bold text-[#0B2F64]">Ubah Kata Sandi</h3>
